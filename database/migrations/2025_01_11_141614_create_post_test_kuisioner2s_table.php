...
class CreatePostTestKuisioner2sTable extends Migration
{
    /**
     * Jalankan migrasi.
     *
    ...
    public function up()
    {
        Schema::create('post_test_kuisioner2s', function (Blueprint $table) {
            $table->id();
            $table->string('nama');
            $table->integer('usia');
    ...
    {
        Schema::dropIfExists('post_test_kuisioner2s');
    }
}
